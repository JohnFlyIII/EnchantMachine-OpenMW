...
- **Add Enchantment** — imbue an unenchanted item with one of your known spells.
- **Remove Enchantment** — strip an existing enchantment and refund soul power.
...
**Custom summon:**
1. Stand near a living creature.
2. Remote → Mark Summon Creature → pick the creature.
3. Defeat it before the mark expires.
4. Cast the new `Summon {creature}` spell; the summon lasts 60 seconds.
...
| Settings page missing | Confirm OpenMW 0.51 RC and the `lua-scripts=` line. |
